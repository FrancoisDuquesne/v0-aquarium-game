...
export const FISH_CONFIG = {
  ...
  BOUNDARY_BOTTOM: 78,
  FISH_SIZES: {
    neon: { width: 34, height: 14 },
    goldfish: { width: 44, height: 28 },
    tropical: { width: 48, height: 30 },
    angelfish: { width: 32, height: 42 },
    shark: { width: 80, height: 38 },
    betta: { width: 40, height: 28 },
    "cherry-barb": { width: 34, height: 16 },
    guppy: { width: 34, height: 21 },
    "pearl-gourami": { width: 46, height: 26 },
    "tiger-barb": { width: 34, height: 24 },
